...
class PlaySeason {
    ...
    void run() {
        ...
        println "$m calling SimulationManager.playSimGame()... SimID: $simulationID  Rounds Remaining: ${sim.schedule.rounds.size()}"
        simMgr.playSimRound(sim, true, sim.schedule.rounds.size())
